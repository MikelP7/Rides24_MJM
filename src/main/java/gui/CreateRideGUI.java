...
public class CreateRideGUI extends JFrame {
	...
	public CreateRideGUI(Driver driver) {
		...
		jCalendar.setBounds(new Rectangle(397, 52, 256, 152));
		scrollPaneEvents.setBounds(new Rectangle(100, 330, 539, 170));

		jButtonCreate.setBounds(new Rectangle(196, 506, 130, 30));
		...
		jButtonClose.setBounds(new Rectangle(397, 506, 130, 30));
		...
		jLabelDestination.setBounds(6, 86, 61, 16);
		getContentPane().add(jLabelDestination);
		
		
		fieldOrigin.setBounds(100, 53, 162, 26);
		getContentPane().add(fieldOrigin);
		fieldOrigin.setColumns(10);
		
		
		fieldDestination.setBounds(100, 83, 162, 26);
		...
		lblStopNumber.setBounds(240, 264, 92, 20);
		...
		lblStopNumber_2.setBounds(336, 264, 92, 20);
	...
	private void jButtonCreate_actionPerformed(ActionEvent e) {
		...
		if (error!=null) {
			...
			try {
				...
				Ride r=facade.createRide(fieldOrigin.getText(), fieldDestination.getText(), UtilDate.trim(jCalendar.getDate()), inputSeats, price, driver.getEmail(), stopList);
