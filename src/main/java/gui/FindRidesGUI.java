...
public class FindRidesGUI extends JFrame {
	...
	public FindRidesGUI()
	{
		...
		jLabelEvents.setBounds(179, 236, 259, 16);
		...
		scrollPaneEvents.setBounds(new Rectangle(179, 259, 346, 150));
...
//			List<Ride> l = facade.getRidesByEmail(MainUserGUI.getUser().getEmail(), new String("User"));
//			System.out.println(l);
//		}
