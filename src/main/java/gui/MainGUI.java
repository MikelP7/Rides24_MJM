...
public class MainGUI extends JFrame {
    ...
    private JButton YourRides = new JButton();
	...
	private JButton JButton_YourRides;
	private JButton queryBookings;
	...
	public MainGUI(Driver d) {
		...
		YourRides.setText("Your Rides");
		jContentPane.add(YourRides);
		
		addStop = new JButton();
		addStop.setText("Add Stops");
		jContentPane.add(addStop);
		
		queryBookings = new JButton();
		queryBookings.setText("Query Bookings");
		jContentPane.add(queryBookings);
		jContentPane.add(panel);
		
		YourRides.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
		...
		queryBookings.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent e) {
				JFrame a = new QueryRidesDriverGUI();
				a.setVisible(true);
			}
		});
